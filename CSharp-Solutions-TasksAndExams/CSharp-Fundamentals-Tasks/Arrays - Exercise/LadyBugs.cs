...
namespace _02.Ladybugs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Determine which cells in the field are full
            ...
            // Working with the commands with while loop
            ...
            while (command[0] != "end")
            {
                ...
                // Determine if the ledybugs are within the field(if they are outside, the loop is continuing).
